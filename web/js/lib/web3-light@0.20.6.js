        ...
        d.prototype._requireType = function(t) {
            ...
            if (c !== s) {
                ...
                if (e.isDynamicArray(u))
                    for (var p = c === i ? 2 : 0, h = 0; h < r.length; h++) c === i ? p += +r[h - 1][0] || 0 : c === a && (p += +(r[h - 1] || [])[0] || 0), l += n.formatInputInt(o + h * f + 32 * p).encode();
            ...
            function B(t) {
                ...
                function $(t, e, n, o) {
                    ...
                    if (h < 0 ? --a : (f.c = l, f.e = a, f.s = o, l = (f = r(f, p, d, m, e)).c, c = f.r, a = f.e), h = l[i = a + d + 1], s = e / 2, c = c || i < 0 || null != l[i + 1], c = m < 4 ? (null != h || c) && (0 == m || m == (f.s < 0 ? 3 : 2)) : h > s || h == s && (4 == m || c || 6 == m && 1 & l[i - 1] || m == (f.s < 0 ? 8 : 7)), i < 1 || !l[0]) t = c ? k("1", -d) : "0";
                        ...
                        if (l.length = i, c)
                            for (--e; ++l[--i] > e;) l[i] = 0, i || (++a, l = [1].concat(l));
                        for (s = l.length; !l[--s];);
                ...
                function et(t, e, r, n) {
                    ...
                    if (y) {
                        t: {
                            ...
                            if (n = n || e < 0 || null != y[d + 1] || (c < 0 ? p : p % g[a - c - 1]), n = r < 4 ? (m || n) && (0 == r || r == (t.s < 0 ? 3 : 2)) : m > 5 || 5 == m && (4 == r || n || 6 == r && (s > 0 ? c > 0 ? p / g[a - c] : 0 : y[d - 1]) % 10 & 1 || r == (t.s < 0 ? 8 : 7)), e < 1 || !y[0]) return y.length = 0,
